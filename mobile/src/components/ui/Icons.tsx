...
export function ChartIcon({ size = 24, color, ...props }: IconProps) {
...
export function PhoneIcon({ size = 24, color, ...props }: IconProps) {
    const { colors } = useTheme();
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
            <Path
...
export function LockIcon({ size = 24, color, ...props }: IconProps) {
    const { colors } = useTheme();
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
            <Path
