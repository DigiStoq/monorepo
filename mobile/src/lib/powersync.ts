...
export function getPowerSyncDatabase(): PowerSyncDatabase {
  if (!powerSyncDb) {
    ...
    try {
      console.log("Creating OPSqliteOpenFactory...");
      const factory = new OPSqliteOpenFactory({
        dbFilename: "digistoq.sqlite",
      });
      console.log("OPSqliteOpenFactory created:", !!factory);
      ...
      console.log("PowerSyncDatabase created successfully");
    } catch (e) {
      console.error("Error in getPowerSyncDatabase:", e);
      throw e;
    }
  }
  return powerSyncDb;
