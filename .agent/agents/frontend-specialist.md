...
7. **Tone-on-tone Icon Backgrounds**: Avoid using light background fills (e.g., `bg-primary-50/100`) for icon containers. It's a standard SaaS template behavior. Icons should float cleanly or use high-contrast borders/typography.
...
| **The "Icon Slop"**  | Using soft, low-contrast background fills for icon containers. | **ACTION:** Clear backgrounds. Make icons larger and use transparent shells. |
