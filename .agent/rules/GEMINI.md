...
- **Modern Iconography Mandate:** Avoid "tone-on-tone" or background-fills (e.g., `bg-primary-100`) for icon containers. Icons must be clean, prominent, and use transparent backgrounds. Contrast should be achieved via icon color and sizing, not background-slop. Aim for a premium, floating look.
