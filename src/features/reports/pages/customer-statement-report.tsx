...
const mockStatement: CustomerStatement = {
  ...
  entries: [
    ...
    },
    {
      ...
      description: "Sale - Laptop Pro x5",
      debit: 6000,
      credit: 0,
      balance: 11000,
    },
    ...
    },
    {
      ...
      date: "2024-01-12",
      type: "invoice",
      referenceNumber: "INV-1015",
      description: "Sale - Office Chairs x10",
      debit: 3500,
      credit: 0,
      balance: 10500,
    },
    ...
    },
    {
      ...
      date: "2024-01-18",
      type: "invoice",
      referenceNumber: "INV-1022",
      description: "Sale - Wireless Mouse x50",
      debit: 1250,
      credit: 0,
      balance: 6750,
    },
    ...
    },
    {
      ...
      date: "2024-01-22",
      type: "invoice",
      referenceNumber: "INV-1028",
      description: "Sale - Desk Lamps x20",
      debit: 900,
      credit: 0,
      balance: 7400,
    },
    ...
    },
    {
      ...
      date: "2024-01-28",
      type: "invoice",
      referenceNumber: "INV-1035",
      description: "Sale - Tool Kits x15",
      debit: 2700,
      credit: 0,
      balance: 7100,
    },
    ...
    },
    {
      ...
      description: "Sale - Storage Bins x100",
      debit: 1500,
      credit: 0,
      balance: 6100,
    },
...
export function CustomerStatementReport(): React.ReactNode {
  ...
  const getEntryTypeStyle = (type: CustomerLedgerEntry["type"]): string => {
    switch (type) {
      case "invoice":
  ...
  const getEntryTypeLabel = (type: CustomerLedgerEntry["type"]): string => {
    switch (type) {
      case "invoice":
        return "Invoice";
      case "payment":
                  ...
                  <div>
                    ...
                    <span
                      className={cn(
                        ...
                        statement.customerType === "customer"
        ...
        <Card>
          <CardBody className="py-12 text-center">
            ...
            <p className="text-slate-500">
              Choose a customer or supplier to view their statement
            </p>
          </CardBody>
        </Card>
      )}
